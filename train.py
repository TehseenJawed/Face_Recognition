...
def TrainImages():
   ...
   #recognizer = cv2.LBPHFaceRecognizer_create()#$cv2.createLBPHFaceRecognizer()
    ...
    recognizer.write(r"C:\Users\tehse\Desktop\OpenCV\Face-Recognition-Attendance-System-master\TrainingImageLabel\Trainner.yml")
...
def TrackImages():
    ...
    recognizer.read(r"C:\Users\tehse\Desktop\OpenCV\Face-Recognition-Attendance-System-master\TrainingImageLabel\Trainner.yml")
    harcascadePath = "haarcascade_frontalface_default.xml"
